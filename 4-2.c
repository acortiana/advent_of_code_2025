...
int accessible_roll(char matrix[150][150], char matrix2[150][150], int y, int x, int len_y, int len_x) {
    if (matrix[y][x] != '@') { matrix2[y][x] = '.'; return 0; }
    int count = 0;
...
void main() {
    ...
    int partial;
    char (*tmp1)[150] = matrix;
    char (*tmp2)[150] = matrix2;
    char (*tmp3)[150];
    do {
        partial = 0;
